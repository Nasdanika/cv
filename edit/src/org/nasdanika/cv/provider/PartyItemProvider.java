...
/**
 * This is the item provider adapter for a {@link org.nasdanika.cv.Party} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PartyItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 cvPackage.Literals.PARTY__NAME,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(cvPackage.Literals.PARTY__CONTACT_METHODS);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Party.class)) {
			case cvPackage.PARTY__NAME:
				fireNotifyChanged(new ViewerNotification(notification, notification.getNotifier(), false, true));
				return;
			case cvPackage.PARTY__CONTACT_METHODS:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(cvPackage.Literals.PARTY__CONTACT_METHODS,
				 cvFactory.eINSTANCE.createEMail()));

		newChildDescriptors.add
			(createChildParameter
				(cvPackage.Literals.PARTY__CONTACT_METHODS,
				 cvFactory.eINSTANCE.createPhone()));

		newChildDescriptors.add
			(createChildParameter
				(cvPackage.Literals.PARTY__CONTACT_METHODS,
				 cvFactory.eINSTANCE.createPostalAddress()));

		newChildDescriptors.add
			(createChildParameter
				(cvPackage.Literals.PARTY__CONTACT_METHODS,
				 cvFactory.eINSTANCE.createWebAddress()));
	}
