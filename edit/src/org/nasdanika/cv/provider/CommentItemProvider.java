...
/**
 * This is the item provider adapter for a {@link org.nasdanika.cv.Comment} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CommentItemProvider 
	...
	protected void addDatePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor(
				 getResourceLocator(),
				 getString("_UI_Comment_date_feature"),
				 CvPackage.Literals.COMMENT__DATE,
				 true,
				 false,
				 false,
	...
	protected void addDescriptionPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor(
				 ...
				 CvPackage.Literals.COMMENT__DESCRIPTION,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public String getText(Object object) {
		Date labelValue = ((Comment)object).getDate();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Comment.class)) {
			case CvPackage.COMMENT__DATE:
			case CvPackage.COMMENT__DESCRIPTION:
